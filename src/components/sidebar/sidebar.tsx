    ...
    >
      ...
      >
        <section className='flex flex-col justify-center gap-2 xs:items-center xl:items-stretch'>
          ...
          <Button
            className='accent-tab absolute right-4 bottom-20 bg-main-accent text-lg font-bold text-white
                       outline-none transition hover:brightness-90 active:brightness-75 xs:static xs:bottom-auto
